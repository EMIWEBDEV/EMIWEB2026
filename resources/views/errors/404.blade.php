...
<head>
    ...
    <title>404 – Halaman Tidak Ditemukan | LIMS · PT. Evo Manufacturing Indonesia</title>
    ...
    <style>
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        .desc{font-family:'Inter',sans-serif;font-size:13.5px;line-height:1.75;color:rgba(255,255,255,.5);margin-bottom:32px;animation:fadeUp .5s .25s both;}
        .btn-wrap{display:flex;gap:10px;justify-content:center;flex-wrap:wrap;animation:fadeUp .5s .3s both;}
        ...
        .btn-ghost{display:inline-flex;align-items:center;gap:8px;background:rgba(255,255,255,.06);color:rgba(255,255,255,.55);text-decoration:none;padding:13px 24px;border-radius:50px;font-family:'Nunito',sans-serif;font-weight:600;font-size:13px;border:1px solid rgba(255,255,255,.1);cursor:pointer;transition:all .25s ease;}
        .btn-ghost:hover{background:rgba(255,255,255,.1);color:#d1d5db;transform:translateY(-2px);text-decoration:none;}
        .btn-ghost svg{width:15px;height:15px;fill:currentColor;flex-shrink:0;}
        .card-foot{margin-top:28px;padding-top:20px;border-top:1px solid rgba(255,255,255,.08);display:flex;align-items:center;justify-content:space-between;animation:fadeUp .5s .35s both;}
