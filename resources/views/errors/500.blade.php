...
<head>
    ...
    <title>500 – Kesalahan Server | LIMS · PT. Evo Manufacturing Indonesia</title>
...
<div class="page">
    <div class="card">
        <div class="icon-ring"><span class="icon-inner">⚠️</span></div>
        <span class="err-num">500</span>
        <div class="divider"></div>
        <h1 class="title">Kesalahan Server</h1>
        <p class="desc">Terjadi kesalahan internal pada server.<br>Tim teknis sedang menangani masalah ini. Mohon coba beberapa saat lagi.</p>
