...
export default {
    ...
    methods: {
        async fetchTrenBeratSampelRegistarsi() {
            try {
                const response = await axios.get(
                    "/api/v1/formulator/grafik/registrasi-sampel/tren-uji-sampel"
                );
        ...
        async fetchJumlahSampelPerMesin() {
            try {
                const response = await axios.get(
                    "/api/v1/formulator/grafik/registrasi-sampel/jumlah-sampel-permesin"
                );
                if (response.status === 200 && response.data?.result) {
        ...
        async fetchDistribuasiTujuanSampel() {
            try {
                const response = await axios.get(
                    "/api/v1/formulator/grafik/registrasi-sampel/distribusi-tujuan-pengujian"
                );
                if (response.status === 200 && response.data?.result) {
