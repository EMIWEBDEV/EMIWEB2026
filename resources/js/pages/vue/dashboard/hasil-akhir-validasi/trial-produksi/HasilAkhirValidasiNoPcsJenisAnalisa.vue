    ...
    computed: {
        timelineSteps() {
            const defs = [
                ...
                { label: 'Validasi',         jenis_aksi: 'VALIDASI_TRIAL_PRODUKSI',     icon: 'ri-user-follow-line' },
                { label: 'Finalisasi',       jenis_aksi: 'FINALISASI_TRIAL_PRODUKSI',   icon: 'ri-checkbox-circle-line' },
            ];
            return defs.map(d => ({
                ...d,
