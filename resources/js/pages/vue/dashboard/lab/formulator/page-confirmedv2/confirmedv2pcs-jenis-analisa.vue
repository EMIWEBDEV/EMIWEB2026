                ...
                <div class="col-12 mt-3 content-area">
                    ...
                    <div class="row" v-else>
                        <template v-if="listData.length">
                            ...
                            >
                                <a
                                    :href="`/validasi/hasil/uji-trial/confirmed-analisis/${item.No_Po_Sampel}/multi/${item.No_Fak_Sub_Po}/${item.Id_Jenis_Analisa}`"
                                >
        ...
        async fetchConfirmedUjiAnalisa() {
            ...
            try {
                const response = await axios.get(
                    `/api/v1/formulator/validasi-hasil/uji-tial/multi-qrcode/${this.No_Sampel}/${this.No_Fak_Sub_Sampel}/${this.id_jenis_analisa}`
                );
