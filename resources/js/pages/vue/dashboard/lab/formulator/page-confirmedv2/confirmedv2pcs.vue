                                ...
                                >
                                    ...
                                    >
                                        <a
                                            ...
                                            :href="`/validasi/hasil/uji-trial/${item.No_Po_Sampel}/multi/${item.No_Fak_Sub_Po}/${item.Id_Jenis_Analisa}/confirmed`"
                                        >
                                            <div
        ...
        async fetchConfirmedUjiAnalisa() {
            ...
            try {
                const response = await axios.get(
                    `/api/v1/formulator/validasi-hasil/uji-trial/${this.No_Sub_Sampel}/${this.id_jenis_analisa}`
                );
