                ...
                <div class="col-12 mt-3 content-area">
                    ...
                    <div class="row" v-else>
                        <template v-if="listData.length">
                            ...
                            >
                                <a
                                    :href="`/validasi/hasil/uji-trial/confirmed-analisis/${item.No_Po_Sampel}/single-qr/${item.Id_Jenis_Analisa}`"
                                >
        ...
        async fetchConfirmedUjiAnalisa() {
            ...
            try {
                const response = await axios.get(
                    `/api/v1/formulator/validasi-hasil/uji-trial/no-pcs/${this.No_Sampel}/single-qrcode`
                );
