                                        ...
                                        >
                                            ...
                                            <td>
                                                <a
                                                    ...
                                                    :href="`/uji-ulang/hasil-trial/resampling/reanalisa/${row.No_Po_Sampel}/${row.No_Sampel_Resampling_Origin}/${row.Id_Jenis_Analisa}/${row.No_Sampel_Resampling}/form`"
                                                >
                                                    Resampling
                                                </a>
                                                <span
        ...
        async fetchData() {
            ...
            try {
                ...
                const response = await axios.get(
                    "/api/v1/formulator/resampling/current",
                    {
                        params,
                    }
                );
