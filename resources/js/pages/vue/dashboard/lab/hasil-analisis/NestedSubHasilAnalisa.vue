                ...
                <div class="col-12 mt-3 content-area" v-else>
                    <div v-if="listData.length">
                        ...
                        <a
                            ...
                            :key="index"
                            :href="`/lab/hasil-analisa/multi/${id_jenis_analisa}/${item.No_Po_Sampel}/${flag_multi}/${item.No_Fak_Sub_Po}`"
        ...
        async fetchHasilAnalisaByJenisAnalisa() {
            ...
            try {
                const response = await axios.get(
                    `/api/v1/lab/hasil-analisa/sub/${this.id_jenis_analisa}/${this.no_po_sampel}`
                );
