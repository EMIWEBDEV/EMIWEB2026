<template>
                            ...
                            <div class="d-flex align-items-start gap-3">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <div v-else class="mt-1 text-muted small">
                                        ...
                                        >Single QR — tidak memerlukan pilihan
                                        sub sampel
                                    </div>
                                </div>
                            </div>
    ...
    >
        <div class="modal-dialog modal-xl modal-dialog-scrollable">
            <div class="modal-content">
                <div
                    class="modal-header bg-primary bg-opacity-10 border-primary border-opacity-25"
                >
                    <h5 class="modal-title fw-bold">
...
export default {
    ...
    mounted() {
        ...
        const el = document.getElementById("bulkValidasiLabModal");
        if (el) this.bulkModalInstance = new bootstrap.Modal(el);
        const el2 = document.getElementById("bulkSimpanValidasiLabModal");
