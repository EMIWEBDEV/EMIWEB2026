    ...
    <div class="vld-root">
        ...
        <div class="vld-topbar">
            ...
            <div class="vld-topbar-right">
                ...
                >
                    <i class="ri-time-line me-1"></i>Menunggu Konfirmasi
                </span>
            </div>
        </div>
            ...
            >
                ...
                <div v-if="!selectedItem" class="vld-detail-empty">
                    <div class="vld-detail-empty-inner">
                        ...
                        <h6>Pilih sampel untuk dikonfirmasi</h6>
                        <p>
                            Klik salah satu item dari daftar di sebelah kiri
                            untuk melihat detail hasil analisa trial produksi
                    ...
                    <div class="vld-detail-body">
                        ...
                        <div v-if="loading.detail" class="vld-loading-state">
                            ...
                            <p class="mt-3 text-muted small">
                                Memuat data hasil analisa trial...
                            </p>
                        </div>
                    ...
                    >
                        ...
                        <div class="d-flex gap-2">
                            <button
                                ...
                                data-bs-target="#offcanvasReanalisisTrial"
                            >
    ...
    computed: {
        ...
        emptyMessage() {
            return this.searchQuery ||
                ...
                : "Belum ada data trial produksi menunggu konfirmasi.";
        },
    ...
    methods: {
        ...
        async fetchList(page = 1) {
            ...
            try {
                ...
                const res = await axios.get(
                    "/api/v1/validasi-trial/produksi/current",
                    { params }
                );
                if (res.data?.result) {
        ...
        async selesaikanAnalisa() {
            const r = await Swal.fire({
                title: "Konfirmasi Trial Produksi",
                text: "Data trial produksi akan difinalisasi dan tidak bisa diubah kembali. Lanjutkan?",
                icon: "warning",
            ...
            try {
                ...
                if (res.data.success) {
                    Swal.fire({
                        icon: "success",
                        title: "Berhasil!",
                        text: "Data trial produksi berhasil dikonfirmasi.",
                        timer: 2000,
                    }).then(() => {
