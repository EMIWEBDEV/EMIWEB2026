...
const MultiRumus = defineAsyncComponent(() =>
    import("../../../lab/perhitungan-backup/MultiRumusResampling.vue")
);

const NotRumus = defineAsyncComponent(() =>
    import("../../../lab/perhitungan-backup/NotRumusResampling.vue")
);
    ...
    methods: {
        ...
        async fetchDetails() {
            ...
            try {
                ...
                const response = await axios.get(
                    `/api/v1/lab/resampling/detail-data-sampel/${this.No_Sampel}/${this.No_Fak_Sub_Sampel}/${this.No_Resampling}/${this.Id_Jenis_Analisa}`
                );
        ...
        async fetchNoMultiQrcode() {
            ...
            try {
                ...
                const response = await axios.get(
                    `/api/v1/${no_sampel}/multi-print/${this.reactiveIdJenisAnalisa}`
                );
