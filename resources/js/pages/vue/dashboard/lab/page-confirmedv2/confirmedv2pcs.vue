                                ...
                                >
                                    ...
                                    >
                                        <a
                                            ...
                                            :href="`/lab/confirmed-analisis/v2/${item.No_Po_Sampel}/multi/${item.No_Fak_Sub_Po}/${item.Id_Jenis_Analisa}/confirmed`"
                                        >
                                            <div
        ...
        async fetchConfirmedUjiAnalisa() {
            ...
            try {
                const response = await axios.get(
                    `/api/v2/lab/validasi-selesai/uji-sampel/${this.No_Sub_Sampel}/${this.id_jenis_analisa}`
                );
