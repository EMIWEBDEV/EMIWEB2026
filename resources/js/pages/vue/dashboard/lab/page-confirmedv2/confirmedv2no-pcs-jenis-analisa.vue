                ...
                <div class="col-12 mt-3 content-area">
                    ...
                    <div class="row" v-else>
                        <template v-if="listData.length">
                            ...
                            >
                                <a
                                    :href="`/lab/confirmed-analisis/v2/${item.No_Po_Sampel}/single-qr/${item.Id_Jenis_Analisa}`"
                                >
        ...
        async fetchConfirmedUjiAnalisa() {
            ...
            try {
                const response = await axios.get(
                    `/api/v2/lab/validasi-selesai/uji-sampel/no-pcs/${this.No_Sampel}/single-qrcode-s`
                );
