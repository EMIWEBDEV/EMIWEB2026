                    ...
                    <div class="d-flex align-items-center mb-3 header-content">
                        ...
                        <div>
                            <h1 class="h2 fw-bold text-primary mb-1 main-title">
                                Kumpulan Data Validasi Hasil Analisa
                            </h1>
                ...
                <div class="col-12 mt-3 content-area">
                    <div class="card-body">
                        ...
                        <div v-else-if="listData.length > 0">
                            ...
                            <div
                                v-if="pltPembandingList && pltPembandingList.length > 0"
                                class="card border-0 shadow-sm mb-4"
                                style="border-radius: 10px; overflow: hidden;"
                            >
                                <div class="d-flex align-items-center px-4 py-3" style="background: linear-gradient(135deg, #405189, #2e3a64);">
                                    <i class="fas fa-flask fa-lg text-white me-3"></i>
                                    <div class="text-white">
                                        <div class="fw-bold" style="font-size: 0.95rem; letter-spacing: 0.3px;">Uji Palatabilitas</div>
                                        <div style="font-size: 0.73rem; opacity: 0.8; margin-top: 1px;">Daftar Produk Pembanding</div>
                                    </div>
                                    <span class="badge ms-auto px-3 py-2 rounded-pill" style="background: rgba(255,255,255,0.18); font-size: 0.78rem; color: #fff; letter-spacing: 0.3px;">
                                        <i class="fas fa-layer-group me-1"></i>{{ pltPembandingList.length }} Produk
                                    </span>
                                </div>
                                        ...
                                        <table class="table table-hover align-middle mb-0" style="font-size: 0.875rem;">
                                            <thead>
                                                <tr style="background: #f4f6fb;">
                                                    <th class="px-4 py-2 text-uppercase text-muted fw-semibold border-0" style="font-size: 0.7rem; letter-spacing: 0.8px; width: 50px;">#</th>
                                                    <th class="px-4 py-2 text-uppercase text-muted fw-semibold border-0" style="font-size: 0.7rem; letter-spacing: 0.8px;">Nama Produk Pembanding</th>
                                                    <th class="px-4 py-2 text-uppercase text-muted fw-semibold border-0" style="font-size: 0.7rem; letter-spacing: 0.8px;">Kode Barang</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr v-for="(pb, idx) in pltPembandingList" :key="idx">
                                                    <td class="px-4 py-3">
                                                        <span class="d-inline-flex align-items-center justify-content-center rounded-circle fw-bold" style="width: 26px; height: 26px; font-size: 0.7rem; background: #405189; color: #fff;">{{ idx + 1 }}</span>
                                                    </td>
                                                    <td class="px-4 py-3 fw-semibold text-dark">{{ pb.nama }}</td>
                                                    <td class="px-4 py-3">
                                                        <span v-if="pb.kode" class="badge rounded-pill" style="background: rgba(64,81,137,0.1); color: #405189; font-size: 0.78rem; padding: 5px 12px;">
                                                            <i class="fas fa-barcode me-1"></i>{{ pb.kode }}
                                                        </span>
                                ...
                                <div class="col-xl-12">
                                    <div class="card h-100">
                                        <div class="card-body">
                                            ...
                                            <div
                                                v-else
                                                class="text-center p-3 d-flex align-items-center justify-content-center h-100"
                                            >
                                                <p class="mb-0">
                                                    Data untuk timeline proses
                                                    tidak tersedia.
                                                </p>
                                            </div>
                                        </div>
                            ...
                            >
                                <button
                                    ...
                                    @click="openModalReanalisa"
                                    data-bs-toggle="modal"
                                    data-bs-target="#modalReanalisaSingle"
                                >
                            ...
                            <div class="row">
                                <div class="col-xl-12">
                                    <div class="card h-100">
                                        <div class="card-body">
                                            <h4 class="card-title mb-4">
                                                Grafik Durasi Waktu (Registrasi
                                                vs Pengujian)
                                            </h4>
                                            <apexchart
                                                v-if="listData.length > 0"
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            ...
            >
                <div class="modal-header bg-warning bg-gradient text-dark">
                    <h5
                        class="modal-title fw-bold text-white d-flex align-items-center"
                    >
                        <i class="fas fa-sync-alt me-2 fs-5"></i>
                        Konfirmasi Reanalisa Sampel
                    </h5>
                    <button
                        type="button"
                        class="btn-close"
                ...
                <div class="modal-body p-4">
                    <div
                        class="alert alert-warning border-start border-4 border-warning shadow-sm"
                    >
                        <div class="d-flex">
                            <i
                                class="fas fa-exclamation-triangle fs-4 me-3 mt-1"
                            ></i>
                            <div>
                                <div class="fw-bold mb-1">
                                    Sampel Single QR Code
                                </div>
                                <div class="small">
                                    Sampel ini bukan berasal dari mesin
                                    <b>Finish Good (Filling / Autoclave)</b> dan
                                    tidak memiliki Multi QR Code.
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="border-start border-4 border-primary ps-3 mb-3">
                        ...
                        <ul class="mb-0 small">
                            <li class="mb-1">
                                Reanalisa akan menggunakan
                                <b>nomor sampel yang sama</b>.
                            </li>
                            <li class="mb-1">
                                Sistem hanya akan
                                <b>menaikkan tahapan pengujian</b>.
                            </li>
                            <li class="mb-1">
                                Tidak diperlukan pemilihan nomor baru seperti
                                pada Multi QR.
                            </li>
                        </ul>
                    </div>
                    ...
                    <div
                        class="alert alert-info border-start border-4 border-info shadow-sm"
                    >
                        <div class="d-flex">
                            <i
                                class="fas fa-random fs-5 me-3 mt-1 text-info"
                            ></i>
                            <div class="small">
                                Pada <b>Multi QR Code</b> atau sampel dari mesin
                                <b>Filling / Autoclave</b>, sistem mengharuskan
                                pemilihan nomor sampel baru.
                                <br />
                                Namun untuk kasus ini, reanalisa tetap pada
                                nomor yang sama.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="border-top pt-3">
                        <div class="text-danger small d-flex">
                            ...
                            <div>
                                Setelah dikonfirmasi, status pengujian
                                sebelumnya akan ditandai sebagai
                                <b>Resampling</b> dan tidak dapat dibatalkan.
                            </div>
                        </div>
                    </div>
                </div>
    ...
    computed: {
        timelineChartSeries() {
            ...
            this.listData.forEach((item) => {
                ...
                // Logika untuk periode 'tunggu' (idle)
        ...
        timelineChartOptions() {
            return {
                ...
                colors: [
                    "#008FFB", // Warna biru untuk 'Total Proses'
                    "#FF4560", // Warna merah untuk 'Periode Tunggu'
                ],
                fill: {
                    type: "solid",
                    opacity: 0.8,
        ...
        chartOptions() {
            ...
            const rangeAwal = parseFloat(0);
            const rangeAkhir = parseFloat(100);
            ...
            return {
                ...
                // ✅ Anotasi rentang dibuat menjadi hijau total
                annotations: {
                    yaxis: [
                        {
                            y: rangeAwal,
                    ...
                    y: {
                        formatter: function (
                            ...
                            const test = `Pengujian: ${
                                item.Tanggal_Pengujian.split(" ")[0]
                            }`;
    ...
    methods: {
        ...
        processItems(items, template) {
            if (!Array.isArray(items) || items.length === 0) {
                console.warn("Items bukan array atau kosong:", items);
            ...
            const processedData = Object.values(groupedByFaktur).map(
                (group) => {
                    ...
                    return {
                        ...
                        Flag_FG: firstItemInGroup.Flag_FG || "-",
                        Id_Jenis_Analisa:
            ...
            // Hapus properti internal _originalGroup sebelum mengembalikan data
            processedData.forEach((row) => delete row._originalGroup);
        ...
        async fetchHasilAnalisaByJenisAnalisa() {
            ...
            try {
                const fetchSampel = () =>
                    axios.get(
                        `/api/v2/lab/verifikasi-analisa/single-qrcode/${this.Id_Jenis_Analisa}/${this.No_Sampel}`
                    );
                const fetchTemplate = () =>
                    axios.get(
                ...
                // Retry max 2x jika error
                const [sampelRes, templateRes] = await Promise.allSettled([
                    this.retryFetch(fetchSampel, 2, 500),
                    this.retryFetch(fetchTemplate, 2, 500),
                ]);

                const dataSampel =
                    sampelRes.status === "fulfilled" &&
                    sampelRes.value?.data?.success
                        ? sampelRes.value.data.result.sampel
                        : null;

                const informasi =
                    sampelRes.status === "fulfilled" &&
                    sampelRes.value?.data?.result?.informasi
                        ? sampelRes.value.data.result.informasi
                        : null;

                const template =
                    templateRes.status === "fulfilled" &&
                    templateRes.value?.data?.result
                        ? templateRes.value.data.result
                        : { parameter: [], formula: [] };

                if (!dataSampel || !Array.isArray(dataSampel)) {
                    throw new Error("Data tidak ditemukan atau tidak valid.");
                }

                // Lanjut proses
                this.template = template;

                this.pltPembandingList = informasi?.plt_pembanding || [];
                ...
                this.informasiData = informasi;
                this.fetchBlobPhotos();
            } catch (error) {
                console.error("Gagal memuat hasil analisa:", error);
                this.listData = [];
        ...
        async selesaikanAnalisa(item) {
            ...
            try {
                ...
                if (response.data.success) {
                    ...
                    }).then(() => (location.href = "/lab/confirmed-analisis"));
                } else {
                    throw new Error(
        ...
        async submitReanalisisSingle() {
            ...
            try {
                ...
                Swal.fire({
                    ...
                    location.href = "/lab/confirmed-analisis";
                });
            } catch (error) {
