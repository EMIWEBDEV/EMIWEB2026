            ...
            <div class="card-body p-3 p-md-4 p-lg-5">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="mt-2">
                        ...
                        >
                            ...
                            <div>
                                ...
                                Mohon <strong>periksa kembali</strong> input
                                rumus perhitungan secara seksama.<br />
                                <ul class="mb-0 mt-1">
                                    <li>
                                        Pastikan
                                        <strong>nama kolom</strong> sesuai
                                        dengan jenis analisa.
                                    </li>
                                    <li>
                                        Periksa kembali
                                        <strong>rumus perhitungan</strong> yang
                                        dimasukkan.
                                    </li>
                                    <li>
                                        Pastikan
                                        <strong
                                            >digit pembulatan/desimal</strong
                                        >
                                        sudah sesuai ketentuan.
                                    </li>
                                </ul>
                                Kesalahan pengisian akan berdampak langsung pada
                                <strong>hasil analisa</strong>. Teliti sebelum
                                menyimpan.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-check me-auto mb-3">
                        ...
                        >
                            Saya telah membaca, memahami, dan bertanggung jawab
                            penuh terhadap rumus perhitungan seadainya terjadi
...
export default {
    ...
    methods: {
        ...
        addParameter(id, name) {
            ...
            const isInsideUnclosedFunction = () => {
                if (!this.formulaTokens.length) return false;

                let functionParenLevel = 0;
                for (const token of this.formulaTokens) {
                    if (token.type === "function(") {
                        functionParenLevel++;
                    } else if (token.type === ")") {
                        if (functionParenLevel > 0) {
                            functionParenLevel--;
                        }
                    }
                }
                return functionParenLevel > 0;
            };

            if (this.isOperand(lastToken)) {
                if (isInsideUnclosedFunction()) {
                    this.formulaTokens.push({
                        display: ",",
                        code: ",",
                        type: "comma",
