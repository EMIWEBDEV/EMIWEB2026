...
export default {
    ...
    methods: {
        async saveToDatabase() {
            ...
            try {
                if (
                    !this.form.Nama_Template ||
                    !this.form.Lebar_Label ||
                    !this.form.Tinggi_Label
                ) {
                    ElMessage({
                        type: "warning",
                        message: "Semua Form Wajib Di Isi Semua",
                    });
                    return;
                }

                let url = "/api/v1/master-template-printer/store";
                let method = "post";
