            ...
            <div class="card-body">
                <div class="mb-4 text-center text-md-start">
                    <h1 class="text-2xl md:text-3xl font-bold text-primary">
                        Manajemen Perangkat Keys
                    </h1>
                    <p class="text-sm md:text-base text-muted">
                        Daftar Mesin Berdasarkan Komputer Keys Komputer PT. Evo
                ...
                >
                    <a
                        href="/biding-identity/create/mesin-identity"
                ...
                <div class="col-12 mt-3">
                    ...
                    <div class="list-group" v-else>
                        <div v-if="listData.length">
                            <a
                                :href="
                                    '/biding-identity/page/' + item.Id_Identity
                                "
...
export default {
    ...
    methods: {
        async fetchBindingIdentityKomputer() {
            ...
            try {
                const response = await axios.get("/fetch/biding-identity");
