                ...
                <div class="col-12">
                    <form @submit.prevent="submitForm">
                        ...
                        >
                            ...
                            >
                                <h5 class="mb-0">Analisa #{{ index + 1 }}</h5>
                                <button
                                    v-if="forms.length > 1"
                                    type="button"
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <el-select
                                        v-model="item.Id_Quality_Control"
                                        multiple
                                        collapse-tags
                                ...
                                <div
                                    v-if="item.Id_Quality_Control.length > 0"
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td
                                                        v-for="qcId in item.Id_Quality_Control"
                                                        :key="'td-' + qcId"
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            Posisi
                                            {{
                                                item.Id_Quality_Control.indexOf(
                                                    qcId
                                                ) + 1
                                            }}
                                            ~ {{ getQcLabel(qcId) }}
        ...
        async submitForm() {
            ...
            for (let i = 0; i < this.forms.length; i++) {
                ...
                if (
                    ...
                    form.Id_Quality_Control.length === 0
                ) {
                    ElMessage.error(
                        `Lengkapi Jenis Analisa dan Parameter Quality pada Analisa #${
                            i + 1
                        }`
                    );
                    return;
