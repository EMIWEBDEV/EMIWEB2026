                        ...
                        >
                            ...
                            <div>
                                <h1 class="h2 fw-bold mb-1 main-title">
                                    History Registrasi Sampel Trial
                                </h1>
                                <p class="text-muted mb-0 subtitle">
                                    <i class="fas fa-list-check me-1"></i>
                                    Daftar Lengkap Registrasi Sampel Trial
                                </p>
                            </div>
                        </div>
                    </div>
...
import VisualisasiQuisy from "../../../components/VisualisasiQuisyFormulator.vue";
...
export default {
    ...
    methods: {
        ...
        fetchData() {
            ...
            axios
                .get("/api/v1/formulator/history/registrasi-sampel", {
                    params: {
        ...
        async submitCetakUlangQrCode(data) {
            ...
            try {
                ...
                const response = await axios.post(
                    `/api/v1/formulator/cetak-ulang/qrcode/${data.No_Sampel}/${data.Id_Mesin}`,
                    {
