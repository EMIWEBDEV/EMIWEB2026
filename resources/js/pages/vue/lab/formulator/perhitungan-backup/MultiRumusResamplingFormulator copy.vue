<template>
    <div class="form-panel modern-form">
        <div class="panel-header">
            <h2><i class="fas fa-flask me-2"></i> Sample sdewrwerwe</h2>
    ...
    computed: {
        photoStorageKey() {
            ...
            if (this.is_multi_print === "Y") {
                return `lab_photo_${this.sampleNumber}_${keyAnalisa}_${this.no_ticket}_multiRumus_resampling`;
            }
            return `lab_photo_${this.sampleNumber}_${keyAnalisa}_multiRumus_resampling`;
        },
            ...
            try {
                if (this.is_multi_print === "Y") {
                    ...
                    const response = await axios.post(
                        "/api/v1/formulator/resampling/hasil-trial/multi-qr-code/store",
                        {
                            analyses: payload,
                    ...
                    const response = await axios.post(
                        "/api/v1/formulator/resampling/hasil-trial/single-qr-code/store",
                        {
                            analyses: payload,
                            photo_data: photoBase64,
                            flag_foto: this.Flag_Foto,
