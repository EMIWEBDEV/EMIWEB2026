<template>
    <div class="form-panel modern-form">
        <div class="panel-header">
            <h2>
                <i class="fas fa-flask me-2"></i> Sample Analysis Testing Je
            </h2>
...
export default {
    ...
    methods: {
        ...
        // Tambahkan fungsi penangkap event ini (jika belum ada)
        ...
        async submitAnalysis() {
            // 1. [DIKEMBALIKAN] Pengecekan Foto Wajib menyala
            ...
            // 2. [DIHAPUS] Pengecekan parameter wajib diisi (allInputsFilled) sudah saya buang di sini.
            // Sekarang kalau input form kosong, akan dibiarkan lewat dan nilainya dikirim null.

            try {
                // Pengecekan multi print dan mapping data payload
                ...
                // Pastikan file foto masuk ke FormData
                ...
                // Tentukan endpoint berdasarkan is_multi_print
                // (Pastikan endpoint ini sudah mengarah ke controller versi dummy yang kamu buat tadi ya)
                const apiUrl =
                    this.is_multi_print === "Y"
                        ? "/api/v1/formulator/hasil-trial/multi-qrcode/testing"
                ...
                if (response.status === 201 && response.data.success) {
                    ...
                    Swal.fire({
                        icon: "success",
                        title: "Berhasil",
                        text: "Data (dummy parameter & foto nyata) berhasil disubmit ke backend!",
                    });
                } else {
                    throw new Error(
