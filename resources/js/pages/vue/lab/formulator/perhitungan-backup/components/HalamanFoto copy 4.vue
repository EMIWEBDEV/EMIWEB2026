...
export default {
    ...
    methods: {
        ...
        async startCamera() {
            ...
            // isFocusSupported dan isFocusing bisa dihapus saja kalau mau clean

            try {
                // Gabungkan SEMUA constraint di awal, tambahkan limit frameRate
                const videoConstraints = {
                    width: { ideal: 3840 },
                    height: { ideal: 2160 },
                    frameRate: { ideal: 15, max: 20 }, // 🔥 KUNCI STABILITAS 4K
                };
                ...
                // HAPUS blok pencarian capabilities dan applyConstraints untuk fokus di sini.
                // Biarkan hardware Logitech BRIO yang mengurus autofokusnya sendiri.
                ...
                if (error.name === "NotReadableError") {
                    ...
                    errorMessage =
                        "Kamera tidak mendukung resolusi atau frame rate yang diminta.";
                }
