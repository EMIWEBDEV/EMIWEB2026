        ...
        <div class="system-header">
            <div class="header-content">
                <h1 class="system-title">
                    <i class="fas fa-vials"></i> Trial Sampel Testing
                </h1>
...
const MultiRumus = defineAsyncComponent(() =>
    import("./perhitungan-backup/MultiRumusFormulator2.vue")
);
    ...
    methods: {
        handleClickLab: throttle(async function (idJenisAnalisa, Kode_Analisa) {
            ...
            try {
                const response = await axios.get(
                    `/api/v1/formulator/uji-trial/${idJenisAnalisa}/parameter-perhitungan-old/testing`
                );
        ...
        async fetchDetails() {
            ...
            try {
                ...
                const response = await axios.get(
                    `/api/v1/formulator/detail-data-sampel/testing/${no_sampel}`
                );
        ...
        async fetchNoMultiQrcode() {
            ...
            try {
                ...
                const response = await axios.get(
                    `/api/v1/formulator/${this.sampleNumber}/${no_sampel}/multi-print/${this.reactiveIdJenisAnalisa}/testing`
                );
                if (
