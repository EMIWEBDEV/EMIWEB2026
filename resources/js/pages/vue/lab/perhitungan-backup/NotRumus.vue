        ...
        async fetchDraftData() {
            ...
            try {
                ...
                if (isMulti === "Y") {
                    ...
                    endpointData = `/api/v1/detail/${this.No_Fak_Sub_Po}/multi-print/${this.Id_Jenis_Analisa}`;
                    endpointSplit = `/api/v1/detail-split/${this.No_Fak_Sub_Po}/multi-print/${this.Id_Jenis_Analisa}`;
                    endpointTracking = `/api/v1/tracking-detail/${this.No_Po_Sampel}/${this.No_Fak_Sub_Po}/multi-print/${this.Id_Jenis_Analisa}/analisa`;
                } else {
        ...
        async submitAnalysisSementara() {
            ...
            try {
                if (isMulti === "Y") {
                    ...
                    const response = await axios.post(
                        "/uji-sampel/store-multi-qr-code-no-perhitungan/sementara",
                        { analyses: payload },
                        {
                            headers: {
                                "X-CSRF-TOKEN": document
