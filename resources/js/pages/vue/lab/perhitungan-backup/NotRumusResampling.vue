...
export default {
    ...
    props: {
        ...
        /* ── Resampling identifiers (sebelumnya hilang) ── */
        Tahapan_Ke: {
            type: [String, Number],
            default: null,
        },
            ...
            try {
                ...
                if (response.status === 201 && response.data.success) {
                    ...
                    Swal.fire({
                        ...
                        window.location.href = "/lab/resampling/current";
                    });
                } else {
                    throw new Error(
...
══════════════════════════════════════════════════════ */
.plt-rsmp-bar { display: flex; align-items: flex-start; justify-content: space-between; flex-wrap: wrap; gap: 0.75rem; padding: 0.85rem 1rem; background: linear-gradient(135deg, #e0f2fe 0%, #f0f9ff 100%); border: 1px solid #7dd3fc; border-left: 4px solid #0ea5e9; border-radius: 10px; margin: 0.5rem 0.5rem 0; }
.plt-rsmp-bar-left { display: flex; align-items: flex-start; gap: 0.7rem; flex: 1; min-width: 0; }
.plt-rsmp-icon { font-size: 1.3rem; color: #0ea5e9; flex-shrink: 0; margin-top: 2px; }
.plt-rsmp-title { font-size: 0.75rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.06em; color: #0369a1; margin-bottom: 0.4rem; }
.plt-rsmp-chips { display: flex; flex-wrap: wrap; gap: 0.35rem; }
.plt-rsmp-chip { display: inline-flex; align-items: center; gap: 0.25rem; padding: 0.22rem 0.6rem 0.22rem 0.35rem; background: #fff; border: 1.5px solid #bae6fd; border-radius: 20px; font-size: 0.78rem; font-weight: 600; color: #0c4a6e; cursor: pointer; transition: all 0.15s ease; user-select: none; }
.plt-rsmp-chip:hover { border-color: #0ea5e9; background: #e0f2fe; }
.plt-rsmp-chip--active { background: #0ea5e9 !important; border-color: #0284c7 !important; color: #fff !important; }
.plt-rsmp-chip-num { width: 16px; height: 16px; border-radius: 50%; background: #0369a1; color: #fff; font-size: 9px; font-weight: 700; display: flex; align-items: center; justify-content: center; flex-shrink: 0; }
.plt-rsmp-chip--active .plt-rsmp-chip-num { background: rgba(255,255,255,0.3); }
.plt-rsmp-bar-right { display: flex; flex-direction: column; align-items: flex-end; flex-shrink: 0; }
.plt-rsmp-selected-label { font-size: 0.7rem; color: #0369a1; font-weight: 500; }
.plt-rsmp-selected-name { font-size: 0.82rem; color: #0c4a6e; font-weight: 700; }
@media (max-width: 575.98px) {
    .plt-rsmp-bar { flex-direction: column; padding: 0.7rem 0.85rem; margin: 0.5rem 0 0; }
    .plt-rsmp-bar-right { flex-direction: row; gap: 0.4rem; align-items: center; }
}
</style>
