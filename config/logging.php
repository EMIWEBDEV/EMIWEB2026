...
return [
    ...
    */
    ...
    'channels' => [
        ...
        'JenisAnalisaController' => [
            'driver' => 'daily',
            'path' => storage_path('logs/JenisAnalisaController.log'),
            'level' => env('LOG_LEVEL', 'debug'),
            'days' => 30,
        ],
        'FormulatorFinalisasiController' => [
            'driver' => 'daily',
            'path' => storage_path('logs/FormulatorFinalisasiController.log'),
            'level' => env('LOG_LEVEL', 'debug'),
            'days' => 30,
        ],
        'ProgressAnalisaSampelController' => [
            'driver' => 'daily',
            'path' => storage_path('logs/ProgressAnalisaSampelController.log'),
            'level' => env('LOG_LEVEL', 'debug'),
            'days' => 30,
        ],
        'SubMenuController' => [
            'driver' => 'daily',
            'path' => storage_path('logs/SubMenuController.log'),
            'level' => env('LOG_LEVEL', 'debug'),
            'days' => 30,
        ],
        'FormulatorCetakUlangQrCodeController' => [
            'driver' => 'daily',
            'path' => storage_path('logs/FormulatorCetakUlangQrCodeController.log'),
            'level' => env('LOG_LEVEL', 'debug'),
            'days' => 30,
        ],
        'FormulatorStatusDataController' => [
            'driver' => 'daily',
            'path' => storage_path('logs/FormulatorStatusDataController.log'),
            'level' => env('LOG_LEVEL', 'debug'),
            'days' => 30,
        ],
        'UserRoleController' => [
            'driver' => 'daily',
            'path' => storage_path('logs/UserRoleController.log'),
            'level' => env('LOG_LEVEL', 'debug'),
            'days' => 30,
        ],
        'ValidasiLabProduksiTrialController' => [
            'driver' => 'daily',
            'path' => storage_path('logs/ValidasiLabProduksiTrialController.log'),
            'level' => env('LOG_LEVEL', 'debug'),
            'days' => 30,
        ],
        'ManagementAksesKontenController' => [
            'driver' => 'daily',
            'path' => storage_path('logs/ManagementAksesKontenController.log'),
            'level' => env('LOG_LEVEL', 'debug'),
            'days' => 30,
        ],
        'MasterMesinController' => [
            'driver' => 'daily',
            'path' => storage_path('logs/MasterMesinController.log'),
            'level' => env('LOG_LEVEL', 'debug'),
            'days' => 30,
        ],
        'AbsensiController' => [
            'driver' => 'daily',
            'path' => storage_path('logs/AbsensiController.log'),
            'level' => env('LOG_LEVEL', 'debug'),
            'days' => 30,
        ],
        'BindingMacMesinController' => [
            'driver' => 'daily',
            'path' => storage_path('logs/BindingMacMesinController.log'),
            'level' => env('LOG_LEVEL', 'debug'),
            'days' => 30,
        ],
        'ExpeditionController' => [
            'driver' => 'daily',
            'path' => storage_path('logs/ExpeditionController.log'),
            'level' => env('LOG_LEVEL', 'debug'),
            'days' => 30,
        ],
        'FormulatorDashboardController' => [
            'driver' => 'daily',
            'path' => storage_path('logs/FormulatorDashboardController.log'),
            'level' => env('LOG_LEVEL', 'debug'),
            'days' => 30,
        ],
        'FormulatorRekapitulasiTrialController' => [
            'driver' => 'daily',
            'path' => storage_path('logs/FormulatorRekapitulasiTrialController.log'),
            'level' => env('LOG_LEVEL', 'debug'),
            'days' => 30,
        ],
        'MenuController' => [
            'driver' => 'daily',
            'path' => storage_path('logs/MenuController.log'),
            'level' => env('LOG_LEVEL', 'debug'),
            'days' => 30,
        ],
        'MesinController' => [
            'driver' => 'daily',
            'path' => storage_path('logs/MesinController.log'),
            'level' => env('LOG_LEVEL', 'debug'),
            'days' => 30,
        ],
        'MasterSerialController' => [
            'driver' => 'daily',
            'path' => storage_path('logs/MasterSerialController.log'),
            'level' => env('LOG_LEVEL', 'debug'),
            'days' => 30,
        ],
        'TrackingController' => [
            'driver' => 'daily',
            'path' => storage_path('logs/TrackingController.log'),
            'level' => env('LOG_LEVEL', 'debug'),
            'days' => 30,
        ],
        'papertrail' => [
