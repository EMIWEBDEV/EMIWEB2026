...
namespace App\Http\Controllers\FormulatorCetakUlangQrCode;
...
class FormulatorCetakUlangQrCodeController extends Controller
{
   public function timbangan()
    ...
    {
        return inertia("vue/quisy/formulator/CetakUlangQrCode");
    }
    ...
    public function getDataHistoriRegistrasiSampel(Request $request)
    {
        try {
            ...
            $baseQuery = DB::table('N_LIMS_PO_Sampel as pos')
            ...
            $children = DB::table('N_LIMS_PO_Sampel_Multi_QrCode')
            ...
            $trackingData = DB::table('N_EMI_LIMS_Activity_Produksi_Sampel')
                ->select(
                    'N_EMI_LIMS_Activity_Produksi_Sampel.No_Po', 
                    'N_EMI_LIMS_Activity_Produksi_Sampel.No_Split_Po',
                    'N_EMI_LIMS_Activity_Produksi_Sampel.No_Batch', 
                    'N_EMI_LIMS_Activity_Produksi_Sampel.Jenis_Aktivitas', 
                    'N_EMI_LIMS_Activity_Produksi_Sampel.Status_Aktivitas', 
                    'N_EMI_LIMS_Activity_Produksi_Sampel.Keterangan', 
                    'N_EMI_LIMS_Activity_Produksi_Sampel.Tanggal', 
                    'N_EMI_LIMS_Activity_Produksi_Sampel.Jam', 
                    'N_EMI_LIMS_Activity_Produksi_Sampel.Flag_Berhasil_Cetak_QrCode', 
                    'N_EMI_LIMS_Activity_Produksi_Sampel.Id_User As Petugas',
                    'EMI_Master_Mesin.Nama_Mesin'
                 )
                ->whereIn('No_Po', $noPos)
                ->leftJoin('EMI_Master_Mesin', 'N_EMI_LIMS_Activity_Produksi_Sampel.Id_Mesin', '=', 'EMI_Master_Mesin.Id_Master_Mesin')
    ...
    public function cetakUlangQrCode(Request $request, $no_sampel, $id_mesin)
    {
        ...
        try {
            ...
            $getData = DB::table('N_LIMS_PO_Sampel as q')
    ...
    {
        $getData = DB::table("N_LIMS_PO_Sampel")
    ...
    {
        $getData = DB::table('N_LIMS_PO_Sampel AS ps')
