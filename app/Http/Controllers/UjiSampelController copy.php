...
class UjiSampelController extends Controller
{
    ...
    public function storeMultiRumusV2(Request $request)
    {
        ...
        // ============================================
        // === START OPTIMIZED v15 (FIXED) ===
        // ============================================

        $logChannel = Log::channel('trackingPerformersToDatabaseMultiRumus'); // Channel Log Baru
        ...
        try {
            ...
            $prefix = 'FUS' . date('my'); // Prefix untuk tabel final

            // --- [OPTIMISASI v13] Gabung 3 Kueri Setup ---
            // Kueri 'LastNoFaktur' sekarang cepat karena index di No_Faktur
            ...
            "; // Menggunakan tabel final N_EMI_LAB_Uji_Sampel
