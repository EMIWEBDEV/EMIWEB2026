...
class QuisyController extends Controller
{
    ...
    public function cetakUlangQrCode(Request $request, $no_sampel, $id_mesin)
    {
        ...
        try {
            ...
            // Variabel Data untuk Replace Placeholder
            ...
            // 1. Ambil Template Transaksi yang Default (Flag_Default = 'Y')
            ...
            // 2. Ambil Master Template (Lebar, Tinggi, Direction)
            ...
            for ($i = 0; $i < $jumlahCetak; $i++) {
                ...
                dd($masterTemplate, $tsplContent);

                // Kirim ke Node.js dengan Direction dari Database
                $response = Http::timeout(360)->post('http://192.168.11.190:3000/print', [
            ...
            DB::table('N_EMI_LAB_Activity_Produksi_Sampel')->insert($payloadActivityProduksiSampel);
            Log::channel('QuisyController')->error($e->getMessage());
            return response()->json([
                'success' => false,
                'status'  => 500,
