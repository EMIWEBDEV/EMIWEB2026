    ...
    public function cetakUlangQrCode(Request $request, $no_sampel, $id_mesin)
    {
        ...
        try {
            ...
            for ($i = 0; $i < $jumlahCetak; $i++) {
                ...
                $tsplContent  = "TEXT 30,15,\"2\",0,1,1,\"$getNamaSampel->Nama\"\r\n";
                $tsplContent .= "TEXT 30,55,\"1\",0,1,1,\"$qrData\"\r\n";
                $tsplContent .= "TEXT 30,80,\"1\",0,1,1,\"$no_Split\"\r\n";
                $tsplContent .= "TEXT 30,100,\"1\",0,1,1,\"Batch $batch\"\r\n";
                $tsplContent .= "TEXT 30,127,\"2\",0,1,1,\"$tanggal\"\r\n";
                $tsplContent .= "TEXT 250,55,\"1\",0,1,1,\"$namaMesin\"\r\n";
                $tsplContent .= "QRCODE 250,80,H,3,A,0,M2,S7,\"$qrData\"\r\n";
