    ...
    function windowResizeHover() {
        ...
        if (windowSize < 1025 && windowSize > 767) {
            ...
            if (sessionStorage.getItem("data-layout") == "vertical") {
                document.documentElement.setAttribute(
                    "data-sidebar-size",
                    localStorage.getItem("data-sidebar-size") || "lg" // Default to lg if not set
                );
            }
            if (document.querySelector(".hamburger-icon")) {
                document
            ...
            case isLayoutAttributes:
                ...
                switch (isLayoutAttributes["data-sidebar-size"]) {
                    case "lg":
                        ...
                        document.documentElement.setAttribute(
                            "data-sidebar-size",
                            localStorage.getItem("data-sidebar-size") || "lg" // Use localStorage value or default to 'lg'
                        );
                        break;
                    ...
                    case "sm":
                        ...
                        document.documentElement.setAttribute(
                            "data-sidebar-size",
                            localStorage.getItem("data-sidebar-size") // Always use stored value
                        );
                        break;
                    ...
                    default:
                        var sidebarSize =
                            localStorage.getItem("data-sidebar-size") || "lg";
                        document.documentElement.setAttribute(
                            "data-sidebar-size",
                            sidebarSize
                        );
        ...
        if (!sessionStorage.getItem("defaultAttribute")) {
            ...
            attributesValue.forEach(function (x) {
                if (x && x.nodeName && x.nodeName != "undefined") {
                    ...
                    // Special handling for sidebar size
                    if (nodeKey === "data-sidebar-size") {
            ...
            // If sidebar size not set in localStorage, set default to 'lg'
            if (!localStorage.getItem("data-sidebar-size")) {
                localStorage.setItem("data-sidebar-size", "lg");
            ...
            isLayoutAttributes["data-sidebar-size"] =
                localStorage.getItem("data-sidebar-size") || "lg"; // Fallback to 'lg' if not set
