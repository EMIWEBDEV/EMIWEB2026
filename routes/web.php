...
Route::middleware(['auth'])->group(function () {
    Route::get('/master-template-printer', [PrinterTemplatesControllerController::class, 'masterViewPrinter'])->middleware( 'autotrack');
    Route::get('/master-template-printer-items', [PrinterTemplatesControllerController::class, 'masterViewPrinterItems'])->middleware( 'autotrack');
    Route::get('/master-template-printer-transaksi', [PrinterTemplatesControllerController::class, 'masterViewPrinterTransaksi'])->middleware( 'autotrack');
...
Route::middleware(['auth', 'web'])->group(function () {
    Route::get('/home', [QuisyController::class, 'index'])->name('quisy.index')->middleware( 'autotrack');
    ...
    Route::get('/master-akun', [AuthController::class, 'ViewMasterAkun'])->name('masterakun.index')->middleware( 'autotrack', 'permission:Master_Akun,VIEW');
    Route::get('/master-akun/tambah-akun', [AuthController::class, 'form_register'])->name('register.form')->middleware( 'autotrack', 'permission:Master_Akun,CREATE');
    Route::get('/api/v1/master-akun/current', [AuthController::class, 'getDataAkunPengguna']);
    ...
    Route::get('/api/v1/dashboard/current-all-time', [DashboardController::class, 'getTotalWidget']);
    Route::get('/api/v1/dashboard/grafik/jumlah-uji-perhari', [DashboardController::class, 'grafikAnalisaData']);
    ...
    Route::get('/cetak-ulang-qrcode', [QuisyController::class, 'HalamanCtkUlangQrcode'])->name('quisy.cetakulangqrcode');
    ...
    Route::get("/data/identity-komputer", [IdentityController::class, "getDataIdentity"]);
    Route::get("/data-search/identity-komputer", [IdentityController::class, "search"]);
    Route::get("/identity-ssidevo", [IdentityController::class, "index"])->middleware('autotrack', 'permission:Master_Key_Komputer,VIEW')->name('identity.index');
    Route::post("/identity-ssidevo/gaskeun", [IdentityController::class, "store"])->name('identity.store')->middleware('permission:Master_Key_Komputer,CREATE');
    Route::put("/api/v1/identity-ssidevo/{id}", [IdentityController::class, "update"])->name('identity.update')->middleware('permission:Master_Key_Komputer,EDIT');
    Route::post('/generate-key', [IdentityController::class, 'generateKey'])->name('identity.generate');

    Route::get("/biding-identity", [BindingIdentityController::class, "index"])->name('bidingidentity.index');
    ...
    Route::get("/biding-identity/page/{id}", [BindingIdentityController::class, "show"]);
    Route::get("/fetch/biding-identity/{id}", [BindingIdentityController::class, "getDataDetailIdentity"]);
    Route::get("/biding-identity/create/mesin-identity", [BindingIdentityController::class, "create"])->name('bidingidentity.create');
    Route::post("/biding-identity/store", [BindingIdentityController::class, "store"])->name('bidingidentity.store');
    Route::get("/biding-identity/edit-form/{id}", [BindingIdentityController::class, "edit"])->name('bidingidentity.edit');
    ...
    // lab controller 
    Route::get('/lab/home', [UjiSampelController::class, 'index'])->middleware('autotrack', 'permission:Uji_Sampel,VIEW');
    ...
    Route::get('/lab/confirmed-analisis', [UjiSampelController::class, 'viewConfirmedAnalisis'])->middleware('autotrack');
    ...
    Route::get('/lab/hasil-analisa', [UjiSampelController::class, 'viewHasilAnalisa'])->middleware('autotrack');
    Route::get('/lab/hasil-analisa/{id_jenis_analisa}', [UjiSampelController::class, 'viewSubHasilAnalisa'])->middleware('autotrack');
    Route::get('/lab/hasil-analisa/{id_jenis_analisa}/{no_po_sampel}/{flag_multi}', [UjiSampelController::class, 'viewNestedSubHasilAnalisa'])->middleware('autotrack');
    Route::get('/lab/hasil-analisa/multi/{id_jenis_analisa}/{no_po_sampel}/{flag_multi}/{no_sub}', [UjiSampelController::class, 'viewDetaiHasilMulti'])->middleware('autotrack');
    ...
    Route::get('/api/v1/lab/berkas/stream/foto-uji/{key}', [UjiSampelController::class, 'streamFoto']);
    ...
    Route::get('/jenis-analisa', [JenisAnalisaController::class, 'index'])->name('jenisanalisa.index')->middleware( 'autotrack', 'permission:Klasifikasi_Analysis,VIEW');
    Route::get('/fetch/jenis-analisa-current', [JenisAnalisaController::class, 'getDataAllGropedBy']);
    ...
    Route::get('/jenis-analisa/detail/page-current/{jenis_analisa}', [JenisAnalisaController::class, 'show'])->name('jenisanalisa.show')->middleware( 'autotrack');
    Route::get('/jenis-analisa/create', [JenisAnalisaController::class, 'create'])->name('jenisanalisa.create')->middleware('autotrack', 'permission:Klasifikasi_Analysis,CREATE');
    Route::post('/jenis-analisa/store', [JenisAnalisaController::class, 'store'])->name('jenisanalisa.store')->middleware('permission:Klasifikasi_Analysis,CREATE');
    Route::put('/jenis-analisa/update/{id}', [JenisAnalisaController::class, 'update'])->name('jenisanalisa.update');

    Route::get('/binding-jenis-analisa', [BindingJenisAnalisaController::class, 'index'])->name('bindingjenisanalisa.index')->middleware('autotrack', 'permission:Pengaturan_Jenis_Analisa,VIEW');
    Route::get('/fetch/binding-jenis-analisa', [BindingJenisAnalisaController::class, 'getListDataJenisAnalisa']);
    ...
    Route::get('/fetch/binding-jenis-analisa/detail/{id_jenis_analisa}', [BindingJenisAnalisaController::class, 'getDetailParameterJenisAnalisa']);
    Route::get('/fetch/search/binding-jenis-analisa/{id_jenis_analisa}', [BindingJenisAnalisaController::class, 'searchDetailParameter']);
    Route::get('/binding-jenis-analisa/{id_jenis_analisa}', [BindingJenisAnalisaController::class, 'show'])->name('bindingjenisanalisa.show')->middleware( 'autotrack');
    Route::get('/binding-jenis-analisa/create/form', [BindingJenisAnalisaController::class, 'create'])->name('bindingjenisanalisa.create')->middleware( 'autotrack');
    Route::get('/binding-jenis-analisa/edit/form/{id}', [BindingJenisAnalisaController::class, 'edit'])->name('bindingjenisanalisa.edit');
    Route::post('/api/v1/binding-jenis-analisa/store', [BindingJenisAnalisaController::class, 'store'])->name('bindingjenisanalisa.store');
    Route::put('/api/v1/binding-jenis-analisa/update/{id}', [BindingJenisAnalisaController::class, 'update'])->name('bindingjenisanalisa.update');


    Route::get('/perhitungan-rumus', [PerhitunganController::class, 'index'])->name('perhitungan.index')->middleware('autotrack', 'permission:Rumus_Perhitungan_Analysis,VIEW');
    Route::get('/fetch/perhitungan-rumus', [PerhitunganController::class, 'getDataRumusPerhitungan']);
    Route::get('/perhitungan-rumus/show/{id_jenis_analisa}', [PerhitunganController::class, 'show'])->name('perhitungan.show')->middleware('autotrack');
    Route::get('/fetch/perhitungan-rumus/show/{id_jenis_analisa}', [PerhitunganController::class, 'getDetailData']);
    Route::get('/search/perhitungan-rumus/show/{id_jenis_analisa}', [PerhitunganController::class, 'searchDetailData']);
    Route::get('/perhitungan/rumus/create', [PerhitunganController::class, 'create'])->name('perhitungan.create')->middleware('autotrack', 'permission:Rumus_Perhitungan_Analysis,CREATE');
    Route::get('/perhitungan/rumus/edit/{id}', [PerhitunganController::class, 'edit'])->name('perhitungan.edit')->middleware( 'autotrack', 'permission:Rumus_Perhitungan_Analysis,EDIT');
    Route::post('/perhitungan/rumus/store', [PerhitunganController::class, 'store'])->name('perhitungan.store');
    Route::put('/perhitungan/rumus/update/{id}', [PerhitunganController::class, 'update'])->name('perhitungan.update');

    Route::get('/barang-jenis-analisa', [BarangAnalisaController::class, 'index'])->name('barangjenisanalis.index')->middleware('autotrack', 'permission:Barang_Uji_Laboratorium,VIEW');
    Route::get('/barang-jenis-analisa/show/{id}', [BarangAnalisaController::class, 'show'])->name('barangjenisanalis.show')->middleware( 'autotrack');
    Route::get('/api/v1/barang-jenis-analisa/current', [BarangAnalisaController::class, 'getDataBarangAnalisa']);
    ...
    Route::get("/mesin-analisa", [MesinAnalisaController::class, 'index'])->name("mesinanalisa.index")->middleware( 'autotrack');
    ...
    Route::get("/master-mesin", [MasterMesinController::class, 'index'])->name("master-mesin.index")->middleware( 'autotrack');
    Route::get("/api/v1/master-mesin/current", [MasterMesinController::class, 'getDataMasterMesin']);
    ...
    Route::get("/api/v1/master-mesin/search", [MasterMesinController::class, 'searchMasterMesin']);
    Route::post("/api/v1/master-mesin/store", [MasterMesinController::class, 'store']);
    ...
    Route::post("/api/v1/master-menu/store", [MenuController::class, 'store'])->middleware('permission:Master_Menu,CREATE');
    Route::put("/api/v1/master-menu/update/{Id_Menu}", [MenuController::class, 'update'])->middleware('permission:Master_Menu,EDIT');

    Route::get("/api/v1/sub-menu/current", [SubMenuController::class, 'getDataSubMenuJson']);
    
    Route::get("/api/v1/pengguna/current", [AuthController::class, 'getDataAkunPenggunaJson']);
    Route::get("/role/menu/{UserId}", [RoleMenuController::class, 'index']);
    Route::get("/role/home-menu", [RoleMenuController::class, 'viewAksesPage']);
    Route::get("/api/v1/role-menu/current/{UserId}", [RoleMenuController::class, 'getDataMenu']);
    Route::get("/api/v1/role-menu/search/{UserId}", [RoleMenuController::class, 'searchDataMenu']);
    ...
    Route::get("/standar-hasil-analisa/current", [StandarRentangController::class, 'index'])->middleware('autotrack', 'permission:Kriteria_Kelayakan_Analisa,VIEW');
    Route::get("/standar-hasil-analisa/tambah", [StandarRentangController::class, 'create'])->middleware('autotrack', 'permission:Kriteria_Kelayakan_Analisa,CREATE');
    Route::post("/api/v1/standar-hasil-analisa/store", [StandarRentangController::class, 'store'])->middleware('permission:Kriteria_Kelayakan_Analisa,CREATE');
    Route::get("/api/v1/standar-rentang-analisa/current", [StandarRentangController::class, 'getAllCurrent'])->middleware('permission:Kriteria_Kelayakan_Analisa,VIEW');
    Route::get("/api/v1/jenis-analisa/standar", [StandarRentangController::class, 'getJenisAnalisa'])->middleware('permission:Kriteria_Kelayakan_Analisa,VIEW');
    Route::get("/api/v1/jenis-analisa/komponen/{id}", [StandarRentangController::class, 'getKomponenAnalisa'])->middleware('permission:Kriteria_Kelayakan_Analisa,VIEW');
    Route::get("/api/v1/daftar-barang/standar/{id_jenis_analisa}", [StandarRentangController::class, 'getBarangStandarRentang'])->middleware('permission:Kriteria_Kelayakan_Analisa,VIEW');
    ...
    Route::get("/pengajuan-uji-buka-sampel/current", [PengajuanBukaUlangUjiSampelController::class, 'index'])->middleware('autotrack', 'permission:Pelepasan_Sampel_Terkunci,VIEW');
    Route::get("/api/v1/pengajuan-uji-buka-sampel/current", [PengajuanBukaUlangUjiSampelController::class, 'getDataBukUlangUjiSampel'])->middleware('permission:Pelepasan_Sampel_Terkunci,VIEW');
